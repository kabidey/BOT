...
ROUTER_SYSTEM_TOOLS_EMPLOYEE = ROUTER_SYSTEM_TOOLS + (
    ...
    "4. If the question is about 'who do I report to' / 'my reporting chain' → directory_my_reporting_chain.\n"
    ...
    "8. For lists of all departments / locations / designations, use the respective list tools.\n"
    "9. NEVER fabricate names, designations, departments, dates, compensation, or reporting lines.\n"
    "10. NEVER say 'I don't know' without either consulting USER_PROFILE (for self-queries) or "
